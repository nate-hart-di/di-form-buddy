---
description: "Alias for bmad-bmb-agents-module-builder.md"
argument-hint: "Optional: add context after the command (positional args: $ARGUMENTS)"
---
Load and run the BMAD prompt file:

bmad-bmb-agents-module-builder.md

Instructions:
1) Read the entire contents of "/Users/nathanhart/Desktop/projects/di-form-buddy/.codex/prompts/bmad-bmb-agents-module-builder.md".
